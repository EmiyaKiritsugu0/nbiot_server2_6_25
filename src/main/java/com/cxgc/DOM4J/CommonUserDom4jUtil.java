...
public class CommonUserDom4jUtil {

    private String decodingXML;
    public CommonUserDom4jUtil(String xml){
        decodingXML = xml;
    }

    /**
     * decode the input String(xml) into CommonUserCommand
     * @return the decoded command
     */
    public CommonUserCommand commandDecode(){
        CommonUserCommand cmd = getCommand(decodingXML);
        return cmd;
    }

    /**
     * 把xml转换为CommonUserCommand对象
     * @param xml
     * @return
     */
    public CommonUserCommand getCommand(String xml){
        CommonUserCommand comd = null;
        ...
        try{
            ...
            comd = (CommonUserCommand) com.cxgc.DOM4J.XmlUtil.fromXmlToBean(root, CommonUserCommand.class);
        } catch (Exception e) {
    ...
    *//**
    ...
    public static Person getPerson(String xml) {
        ...
        try {
            document = reader.read(in);
            Element root = document.getRootElement();
            person = (Person) com.cxgc.DOM4J.XmlUtil.fromXmlToBean(root, Person.class);
    ...
    public static List<Person> getPersonList(String xml) {
        ...
        try {
            ...
            while (it.hasNext()) {
                ...
                Person baseBean = (Person) com.cxgc.DOM4J.XmlUtil.fromXmlToBean(
